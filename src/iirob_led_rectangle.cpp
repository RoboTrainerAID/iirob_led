...
IIROB_LED_Rectangle::IIROB_LED_Rectangle(ros::NodeHandle nodeHandle, std::string const& _port, int const& _m_numLeds)
    : m_led(0), m_msec(1),
      ...
      blinkyAS(nodeHandle, "blinky", boost::bind(&IIROB_LED_Rectangle::blinkyCallback, this, _1), false),
      policeAS(nodeHandle, "police", boost::bind(&IIROB_LED_Rectangle::policeCallback, this, _1), false),
      fourRegionsAS(nodeHandle, "four_regions", boost::bind(&IIROB_LED_Rectangle::fourRegionsCallback, this, _1), false),
      chaserLightAS(nodeHandle, "chaser_light", boost::bind(&IIROB_LED_Rectangle::chaserLightCallback, this, _1), false),
      MAX_FORCE(10)
{
...
void IIROB_LED_Rectangle::checkLimits(int *start_led, int *end_led) {
...
bool IIROB_LED_Rectangle::init(std::string const& port, int const& m_numLeds) {
    // Initialize the hardware
...
void IIROB_LED_Rectangle::spin() { ros::spin(); }

bool IIROB_LED_Rectangle::getStatus() { return status; }
...
void IIROB_LED_Rectangle::fourRegionsCallback(const iirob_led::FourRegionsGoal::ConstPtr& goal) {
...
void IIROB_LED_Rectangle::chaserLightCallback(const iirob_led::ChaserLightGoal::ConstPtr& goal) {
