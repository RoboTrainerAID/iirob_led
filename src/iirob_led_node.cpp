...
int main(int argc, char **argv)
{
    ...
    nh.param<double>("max_force", max_force, 20);
    ...
    ROS_INFO("Maximum force set to %.3f", max_force);
    ...
    if(!type.compare("cross")) {
        ...
        IIROB_LED_Cross *crossStrip = new IIROB_LED_Cross(nh, port, led_num, link, max_force);
        ...
        IIROB_LED_Rectangle *rectangleStrip = new IIROB_LED_Rectangle(nh, port, led_num, link, max_force);
